...
<head>
    ...
    <title> Izmena Fotografije Profesora </title>
...
<?php include("../navbar.php")?>
    ...
    <?php echo "<img src='../assets/".$_SESSION['fotografijaKorisnika']."' style='width:10%; height:10%;  float:right; alt='Profila slika'>"?>
		<h2 class="pb-4"> <strong> Izmena fotografije profesora </strong> </h2>

		
		<form action="updateProfesorPhotoProcess.php" method="post" enctype="multipart/form-data">
