        ...
        if(!in_array($extension, ['jpeg', 'jpg', 'png', 'gif'])) {
            ?>
                <script> 
                    ...
                    window.location="../nastavnik/FotografijaProfesorEdit.php"; 
                </script>
            ...
            if(move_uploaded_file($tmp, $target)) {
                ...
                $query = "UPDATE profesor SET fotografija='$image' WHERE idProfesora = '$id'";
                ...
                <?php
                    ...
                    <script> 
                        window.alert("Greska! Fotografija nije sacuvana"); 
                        window.location="../nastavnik/FotografijaProfesorEdit.php";
                    </script>
                <?php
                } 
